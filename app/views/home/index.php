...
<head>
  ...
  <title>SETUP PROJECT WEBPRO</title>
</head>
<body>
<h1>Halaman HOME SETUP</h1>
<p>Menu penting yang akan digunakan buat rental nantinya</p>
  <ul>
    <li>
    <a href="<?= BASEURL ?>/Admin">Halaman Admin</a>
    </li>
    <li>
    <a href="<?= BASEURL ?>/Pelanggan">Halaman Pelanggan</a>
    </li>
  </ul>
</body>
</html>
...
<html lang="en">
   ...
   <body id="default_theme" class="home_page1">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin_bottom_30">
                     <div class="full width_9" style="margin-bottom:25px;"> <a href="index.html"><img class="img-responsive" width="250" src="<?= BASEURL ?>/asset/images/logo.png" alt="#"></a> </div>
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 margin_bottom_30">
                     <div class="full">
                        ...
                        <div class="blog_post_footer">
                           <div class="blog_post_img"> <img width="80" height="80" src="<?= BASEURL ?>/asset/images/scr1.png" alt="#"> </div>
                        ...
                        <div class="blog_post_footer">
                           <div class="blog_post_img"> <img width="80" height="80" src="<?= BASEURL ?>/asset/images/scr2.png" alt="#"> </div>
                           <div class="blog_post_cont">
                              <p class="date">July 22, 2015</p>
                              <p class="post_head">Round and round like a carousel</p>
                           </div>
                        ...
                        <div class="blog_post_footer">
                           <div class="blog_post_img"> <img width="80" height="80" src="<?= BASEURL ?>/asset/images/scr3.png" alt="#"> </div>
                           <div class="blog_post_cont">
                              <p class="date">July 22, 2015</p>
                              <p class="post_head">Round and round like a carousel</p>
                           </div>
      ...
      <!-- wow animation -->
      <script src="<?= BASEURL ?>/asset/js/wow.js"></script>
      <!-- custom js -->
      <script src="<?= BASEURL ?>/asset/js/custom.js"></script>
      <!-- google map js -->
